...
int modbus_source_init(modbus_source_config* cfg, Bus *b, const char* mbtype, const char* host, int port, const char* path, int baud, char parity, int data_bit, int stop_bit, int slave_id);
